  ...
  return (
    <AnimatePresence mode=" popLayout ">
        ...
        <div className="w-full flex justify-center mt-10 overflow-x-hidden overflow-y-hidden z-0">
            ...
            <p className='text-primary text-5xl font-semibold'>All done for today</p>
            <br/>
            <p className='text-3xl font-medium'>Be proud of yourself!</p>
            <br/>
            <br/>
            <button className="btn btn-accent" onClick={pastEntriesHandler}>See your past Entries</button>
            </div>
        </div>
        </motion.div>
        : null}
        {seePastEntries ? <PreviousEntries/> : null}
    </AnimatePresence>
  )
}
